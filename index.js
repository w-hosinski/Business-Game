...
function addMachine1() {
    if(machineNumber<maxMachines && money>=machineCost) {
        document.getElementById("buyMachine").disabled = true;
        document.getElementById("buyMachine").value = "Ordering Machine...";
        money-=machineCost;
...
function addMachine2() {
        ...
        if(machineNumber==maxMachines) {
            ...
            document.getElementById("buyMachine").disabled = false;
        }
        document.getElementById("buyMachine").value = "Buy 1 Machine (0.4$/Second + 14$)"; 
...
function addManufacturingBuilding1() {
    if(manufacturingBuildingNumber<maxManufacturingBuildings && money>=manufacturingBuildingSetupCost){
        document.getElementById("rentManufacturingBuilding").disabled = true;
        document.getElementById("rentManufacturingBuilding").value = "Setting up Building...";
...
function addManufacturingBuilding2() {
    document.getElementById("rentManufacturingBuilding").value = "Rent 1 Manufacturing Building (0.9$/Second + 18$ Setup Cost)";
    maxMachines+=machinesPerManufacturingBuilding;
    if(document.getElementById("buyMachine").value !== "Ordering Machine..."){
    document.getElementById("buyMachine").disabled = false
    }
    ...
    if(manufacturingBuildingNumber==maxManufacturingBuildings){
        ...
        document.getElementById("rentManufacturingBuilding").disabled = false;
    }
...
function addAssembler1() {
    if(money>=assemblerHireCost && maxEmployees>allEmployeesNumber) {
        document.getElementById("hireAssembler").disabled = true;
        document.getElementById("hireAssembler").value = "Hiring Assembler...";
...
function addAssembler2() {
        document.getElementById("hireAssembler").value = "Hire 1 Assembler (0.5$/Second + 7$)";
        assemblerNumber++;   
        document.getElementById("hireAssembler").disabled = false;
        assemblerNumberDisplay.innerHTML = assemblerNumber + " Assemblers";
}
function addQci1() {
    if(money>=qciHireCost && maxEmployees>allEmployeesNumber) {
        document.getElementById("hireQci").disabled = true;
        document.getElementById("hireQci").value = "Hiring Quality Control Inspector...";
        money-=qciHireCost;
...
function addQci2() {
        document.getElementById("hireQci").value = "Hire 1 Quality Control Inspector (0.6$/Second + 9$)";
        qciNumber++;   
        document.getElementById("hireQci").disabled = false;
...
function addAccountant1() {
    if(accountantNumber<maxAccountants && money>=accountantHireCost && maxEmployees>allEmployeesNumber) {
        document.getElementById("hireAccountant").disabled = true;
        document.getElementById("hireAccountant").value = "Hiring Accountant...";
...
function addAccountant2() {
        ...
        if(accountantNumber==maxAccountants) {
            ...
            document.getElementById("hireAccountant").disabled = false;
        }
        document.getElementById("hireAccountant").value = "Hire 1 Accountant (0.6$/Second + 18$)"; 
        accountantNumberDisplay.innerHTML = accountantNumber + " Accountants (max:" + maxAccountants+")";
        if(accountantNumber>1){
            document.getElementById("reduceTaxesResearch").disabled = false;
        }
...
function addOfficeBuilding1() {
    if(officeBuildingNumber<maxOfficeBuildings && money>=officeBuildingSetupCost){
        document.getElementById("rentOfficeBuilding").disabled = true;
        document.getElementById("rentOfficeBuilding").value = "Setting up Building...";
...
function addOfficeBuilding2() {
    document.getElementById("rentOfficeBuilding").value = "Rent 1 Office Building (0.4$/Second + 10$ Setup Cost)";
    maxAccountants+=accountantsPerOfficeBuilding;
    if(document.getElementById("hireAccountant").value !== "Hiring Accountant..."){
        document.getElementById("hireAccountant").disabled = false;
        }
    ...
    if(officeBuildingNumber==maxOfficeBuildings){
        ...
        document.getElementById("rentOfficeBuilding").disabled = false;
    }
...
function reduceTaxesResearch1() {
    if(accountantNumber>1 && money>=officeBuildingSetupCost){
        document.getElementById("reduceTaxesResearch").disabled = true;
        document.getElementById("reduceTaxesResearch").value = "Tax Optimization Ongoing...";
...
function reduceTaxesResearch2() {
    corpTaxRate = 0.2;
    document.getElementById("reduceTaxesResearch").value = "Taxes Optimized! Corporate Income Tax Rate reduced to 20%";
}
function termLoanCheck() {
    if (document.forms["termLoan"]["termLoanAmount"].checkValidity() && document.forms["termLoan"]["termLoanDuration"].checkValidity()){
        ...
        document.getElementById("acceptTermLoan").disabled = false;
        termLoanMonthlyPaymentDisplay.innerHTML = "Your monthly payment will be "+tempTermLoanMonthlyPayment.toFixed(2)+" $";
    }
    else {
        document.getElementById("acceptTermLoan").disabled = true;
...
if (document.forms["termLoan"]["termLoanAmount"].checkValidity() && document.forms["termLoan"]["termLoanDuration"].checkValidity()){
    ...
    document.getElementById("acceptTermLoan").disabled = true;
    document.getElementById("termLoan1NameDisplay").hidden = false;
    document.getElementById("termLoan1PaymentsDisplay").hidden = false;
    document.getElementById("termLoan1TotalDisplay").hidden = false;
...
function ticker() {
    ...
    if(taxCounter==0||taxCounter==(baseTaxCounter/3).toFixed(0)||taxCounter==(baseTaxCounter*0.6666667).toFixed(0)) {
        if(termLoan1MonthsRemaining>0) {
            ...
            document.getElementById("termLoan1NameDisplay").hidden = true;
            document.getElementById("termLoan1PaymentsDisplay").hidden = true;
            document.getElementById("termLoan1TotalDisplay").hidden = true;
        }
    }
